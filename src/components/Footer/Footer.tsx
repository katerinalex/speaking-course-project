    ...
    <footer className='footer'>
      ...
      <div className='footer-container'>
        ...
        <div>
          ...
          <h3 className='footer__title'>+38 000 000 00 00</h3>
        </div>
      </div>
      <h3 className='footer__title footer__title-copyright'>Public speaking courses by Anastasiia Shkiria, 2024 All rights reserved</h3>
    </footer>
  )
}