...
import './AdminCoursesEdit.scss';
import photo from '../../images/Photo_Unknown.png';

export const AdminCoursesEdit:React.FC = () => {
  return (
    <div className="adminPage">
      ...
      <section className="adminPage__content">
        ...
        <div className="adminPage__content__lang">
          <div className="adminPage__content__lang__eu">EU</div>
          <div className="adminPage__content__lang__ua">UA</div>
        </div>

        <div className="adminPage__content__basic">
          <img className="adminPage__content__basic__photo" src={photo} alt="Course" />
          <div className="adminPage__content__basic__info">
            <label htmlFor="name">Name Course</label> 
            <input className="adminPage__content__basic__info__input" type="text" id="name" placeholder='Name'/>
            <div className="adminPage__content__basic__info__input adminPage__content__basic__info__input--radio">
              <div>
                <input type="radio" id="flexible" name="typeOfCourse" value="flexible" checked />
                <label htmlFor="flexible">Flexible</label>
              </div>
              <div>
                <input type="radio" id="flexibleWW" name="typeOfCourse" value="flexibleWW" />
                <label htmlFor="flexibleWW">Flexible with webinars</label>
              </div>
              <div>
                <input type="radio" id="coaching" name="typeOfCourse" value="coaching" />
                <label htmlFor="coaching">Coaching</label>
              </div>
            </div>
            <input className="adminPage__content__basic__info__input" type="text" id="add" value="*Access to all course materials for three months after the course is completed."/>
            <label htmlFor="Price">Price</label> 
            <input className="adminPage__content__basic__info__input" type="text" id="Price" placeholder='Price'/>
            <label htmlFor="image">Download an image to Course</label> 
            <input className="adminPage__content__basic__info__input" type="file" id="image" placeholder='doc'/>
          </div>
        </div>

        <div className="adminPage__content__direction">
          <div className="adminPage__content__direction__title">Direction</div>

          <div className="adminPage__content__direction__items">
            <div className="">
            ...
            <div className="">
              <input type="checkbox" id="bloggers" name="bloggers" checked />
              <label htmlFor="bloggers">Bloggers</label>
            </div>

            <div className="">
              <input type="checkbox" id="CEOandManagers" name="CEOandManagers" checked />
              <label htmlFor="CEOandManagers">CEO and Managers</label>
            </div>
            <div className="">
              <input type="checkbox" id="ConsultantsAndAdvisors" name="ConsultantsAndAdvisors" checked />
              <label htmlFor="ConsultantsAndAdvisors">Consultants and Advisors</label>
            </div>
            <div className="">
              <input type="checkbox" id="EntrepreneursAndStart-upFounders" name="EntrepreneursAndStart-upFounders" checked />
              <label htmlFor="EntrepreneursAndStart-upFounders">Entrepreneurs and Start-up Founders</label>
            </div>
            <div className="">
              <input type="checkbox" id="ForEverydayLife" name="ForEverydayLife" checked />
              <label htmlFor="ForEverydayLife">For everyday life</label>
            </div>
            <div className="">
        ...
        <div className="adminPage__content__skill">
          <div className="adminPage__content__skill__title">Skills</div>
          <input className="adminPage__content__skill__input" type="text" id="skill" value="Slill, skill"/>
        </div>
